...
const NAV_CATEGORIES = [
  {
    ...
    cards: [
      ...
      { name: 'Polüseemia', desc: 'Sõnad reastatud tähenduste arvu järgi.', href: '../poluseemia/index.html' },
      { name: 'Lühiühendus', desc: 'Leia tähendustevahelisi seoseid pidi liikudes lühim tee ühest sõnast teiseni.', href: '../luhiuhendus/index.html' },
      { name: 'Registrimaatriks', desc: 'Registrimärgendiga sõnad.', href: '../registrimaatriks/index.html' },
      { name: 'Sünonüümitihedus', desc: 'Sünonüümid on eri sõnad, mis on sama tähendusega.', href: '../sunonuumid/index.html' },
      ...
      { name: 'Kaashüponüümid', desc: 'Sõnad mis jagavad sama ülemmõistet — kaashüponüümide klastrid.', href: '../kaashuponuumid/index.html' },
      { name: 'Antonüümid', desc: 'Vastupidise tähendusega sõnad.', href: '../antonuumid/index.html' },
    ]
  },
  {
    name: 'Liitsõnad',
    cards: [
      ...
      { name: 'Liitsõnade sügavus', desc: 'Kui liitsõna koosneb teistest liitsõnadest.', href: '../sugavus/index.html' },
  ...
  },
  {
    ...
    cards: [
      ...
      { name: 'Ainult täishäälikud', desc: 'Sõnad mis koosnevad üksnes täishäälikutest', href: '../taishaalikud/index.html' },
      { name: 'Reduplikatsioonid', desc: 'Sõnad kus esimene pool kordab teist poolt', href: '../reduplikatsioonid/index.html' },
      { name: 'Kärpimisahelad', desc: 'Sõnad, mille esimese tähe eemaldamisel tekib uus sõna.', href: '../karpimine/index.html' },
